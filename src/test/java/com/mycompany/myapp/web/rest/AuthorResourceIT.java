...
class AuthorResourceIT {
    ...
    public static Author createEntity(EntityManager em) {
        Author author = new Author().fullname(DEFAULT_FULLNAME).phone(DEFAULT_PHONE).birthdate(DEFAULT_BIRTHDATE).email(DEFAULT_EMAIL);
        return author;
    }
    ...
    public static Author createUpdatedEntity(EntityManager em) {
        Author author = new Author().fullname(UPDATED_FULLNAME).phone(UPDATED_PHONE).birthdate(UPDATED_BIRTHDATE).email(UPDATED_EMAIL);
        return author;
    }
    ...
    void putNewAuthor() throws Exception {
        ...
        updatedAuthor.fullname(UPDATED_FULLNAME).phone(UPDATED_PHONE).birthdate(UPDATED_BIRTHDATE).email(UPDATED_EMAIL);
    ...
    void partialUpdateAuthorWithPatch() throws Exception {
        ...
        partialUpdatedAuthor.phone(UPDATED_PHONE);
    ...
    void fullUpdateAuthorWithPatch() throws Exception {
        ...
        partialUpdatedAuthor.fullname(UPDATED_FULLNAME).phone(UPDATED_PHONE).birthdate(UPDATED_BIRTHDATE).email(UPDATED_EMAIL);
